...
The frontend application for the AI Chat Assistant, built with React, Vite, and Tailwind CSS.
...
- [Main Project Repository](https://github.com/IsabelaBaseggio/ai-chatbot-assistant)
